...
public class PlatoControlador {
    ...
    public List<DTO> getPlatos() {
        ...
        for (Plato p : platos) {
            DTO dtoMoto = new DTO();
            dtoMoto.put("id", p.getId());
            dtoMoto.put("nombre", p.getNombre());
            dtoMoto.put("precio", p.getPrecio());
            dtoMoto.put("descripcion", p.getDescripcion());
            dtoMoto.put("img", p.getImg());
            listPlatosDTO.add(dtoMoto);
        }
